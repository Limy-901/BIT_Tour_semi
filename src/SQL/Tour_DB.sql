...
/* 후기게시판 */
CREATE TABLE REVIEW (
    ARTICLE_NO    VARCHAR2(10)      NOT NULL, /* 글번호 */
    MEMBER_NO     VARCHAR2(10)      CONSTRAINT REVIEW_FK REFERENCES MEMBER(MEMBER_NO), /* 회원번호 */
    NICK          VARCHAR2(20)      NOT NULL, /* 닉네임 */
...
/* 문의게시판 */
CREATE TABLE QNA (
    QNA_NO        VARCHAR2(10)      NOT NULL, /* 글번호 */
    MEMBER_NO     NUMBER      CONSTRAINT QNA_FK REFERENCES MEMBER(MEMBER_NO), /* 회원번호 */
    SUBJECT       VARCHAR2(30)      NOT NULL, /* 제목 */
    CONTENT       VARCHAR2(2000)    NOT NULL, /* 내용 */
    RDATE         DATE              NOT NULL, /* 작성일 */
...
/* 결제 */
INSERT INTO PAYMENT VALUES ('PAY-0001',1, 'PK-0001', 200000, '신용카드', '신한카드', sysdate, 1);
INSERT INTO PAYMENT VALUES ('PAY-0002',2, 'PK-0002', 300000, '체크카드', '우리은행', sysdate, 0);
INSERT INTO PAYMENT VALUES ('PAY-0003',3, 'PK-0003', 400000, '신용카드', '우리카드', sysdate, 1);